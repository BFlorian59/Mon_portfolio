      ...
      <div className='w-full'>
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
          <div className="col-span-4">
            ...
            <p>
              Ceci est mon projet en JavaScript avec des design patterns. C'est un projet sur une agence de photographe nommée Fisheye. 
          ...
          <div className="col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded-xl p-4">
            <div className="p-2">
              ...
              <div className="grid grid-cols-3 md:grid-cols-1">
                ...
                <p className="text-gray-600 py-2 flex items-center"><RiRadioButtonFill className="pr-1" />Design patterns</p>
        ...
        <div className="flex align-middle justify-center m-auto mb-10">
          ...
          <Link className="mr-20" href='https://github.com/BFlorian59/P6_Front-End-Fisheye'>
            <button className='w-full p-4 text-gray-100'>Repot du projet</button>
          </Link>
          <Link href='https://fisheye-one.vercel.app/'>
